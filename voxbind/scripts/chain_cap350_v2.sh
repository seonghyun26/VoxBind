...
#   setsid nohup bash scripts/chain_cap350_v2.sh > log/chain_cap350_v2.log 2>&1 &
set -uo pipefail
...
bash "$VOX/scripts/vanilla_full_eval.sh" "$VOX/exps/$EXP" "$VOX/exps/$EXP/samples/full_eval_ep${ep}" 100
