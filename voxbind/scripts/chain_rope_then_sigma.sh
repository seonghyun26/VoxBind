...
#   setsid nohup bash scripts/chain_rope_then_sigma.sh > log/chain_rope_then_sigma.log 2>&1 &
#
...
#   tail sig=1.0 denoiser    resume ep543 -> 1200 (scripts/35_train_baseline_4gpu.sh)
#
...
SIG=1.0 NUM_EPOCHS=657 RESUME_EPOCH=543 bash "$ROOT/scripts/35_train_baseline_4gpu.sh" \
