...
#
# Examples:
#   bash scripts/docker_shell.sh                                   # interactive bash
#   bash scripts/docker_shell.sh python -c 'import torch'          # one-shot
#   GPUS='"device=0,1,2,3"' bash scripts/docker_shell.sh           # restrict GPUs
#   IMAGE=voxbind:min bash scripts/docker_shell.sh                 # alt image tag
#   SHM_SIZE=32g bash scripts/docker_shell.sh                      # bigger /dev/shm
#
