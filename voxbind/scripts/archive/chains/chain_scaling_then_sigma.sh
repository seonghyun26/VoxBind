...
#   denoiser to ep1600. Mirrors scripts/archive/chains/chain_resample_then_sigma.sh +
#   scripts/archive/chains/chain_sig1.0_extend_to_1600.sh (resume convention / 1600 target).
#
# Launch (detached) — own session/pgid so the denoiser-group kill cannot hit it:
#   cd /home1/irteam/VoxBind/voxbind && \
#   setsid nohup bash scripts/archive/chains/chain_scaling_then_sigma.sh \
