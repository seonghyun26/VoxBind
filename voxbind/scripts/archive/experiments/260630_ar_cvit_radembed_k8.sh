#!/bin/bash
# 260630_ar_cvit_radembed_k8.sh — DRAMATIC change #7: LEARNABLE RADIUS-CONDITIONED ATOM EMBEDDING.
...
GPUS=0,1,2,3; PORT=29617; RID=arRadEm8
EXP=260630_ar_cvit_radembed_k8
...
CUDA_VISIBLE_DEVICES=$GPUS "$PY/torchrun" --nnodes=1 --nproc_per_node=4 \
    ...
    model.channel_groups=[7,4,2] +model.radius_embed_k=8 \
