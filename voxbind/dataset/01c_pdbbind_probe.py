...
FROZEN_SPLIT_SCHEMES = {
    ...
    # Official ATOM3D LBA assignments intersected with lp_edrscc_v2, plus legacy local
    # MMseqs easy-cluster splits retained for result compatibility.
    "atom3d_lba30": "atom3d_lba30_edrscc_v2",  # official ATOM3D assignment ∩ v2 (2078/266/340)
    "atom3d_lba60": "atom3d_lba60_edrscc_v2",  # official ATOM3D assignment ∩ v2 (2150/273/261)
    "atom3d_lba30_v22clean": "atom3d_lba30_edrscc_v2_v22clean",  # train same; val/test 3/9
    "atom3d_lba60_v22clean": "atom3d_lba60_edrscc_v2_v22clean",  # train same; val/test 20/24
    "lba30":        "lba30",           # legacy local MMseqs split (3846/823/1318)
    "lba60":        "lba60",           # legacy local MMseqs split (3828/821/1338)
}
...
def build_parser() -> argparse.ArgumentParser:
    ...
    pr.add_argument("--split", choices=["lp", "lp_edrscc", "lp_edrscc_v1", "lp_edrscc_v2", "lp_edrscc_v2_cl1", "lp_edrscc_v2_cl12", "lp_edrscc_v2_cl123", "time", "misato", "clean_ed", "clean_ed_v1", "clean_ed_v1_indep", "atom3d_lba30", "atom3d_lba60", "atom3d_lba30_v22clean", "atom3d_lba60_v22clean", "lba30", "lba60"], default="lp",
    ...
    pt.add_argument("--cl1_only", action="store_true",
                    help="Restrict to LP_PDBBind CL1=True (cleanest subset); adds _filtered to the CSV name")
    pt.add_argument("--split", choices=["lp", "lp_edrscc", "lp_edrscc_v1", "lp_edrscc_v2", "lp_edrscc_v2_cl1", "lp_edrscc_v2_cl12", "lp_edrscc_v2_cl123", "time", "misato", "clean_ed", "clean_ed_v1", "clean_ed_v1_indep", "atom3d_lba30", "atom3d_lba60", "atom3d_lba30_v22clean", "atom3d_lba60_v22clean", "lba30", "lba60"], default="lp",
