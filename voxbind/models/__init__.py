...
def create_model(cfg, device="cuda") -> VoxBind:
    ...
    model = VoxBind(
        ...
        density_cond_dropout=float(cfg.model.get("density_cond_dropout", 0.0)),
        density_token_spatial_norm=bool(cfg.model.get("density_token_spatial_norm", True)),
        density_token_norm_gamma=float(cfg.model.get("density_token_norm_gamma", 1.0)),
        density_token_group_dim=int(cfg.model.get("density_token_group_dim", 256)),
        density_token_c=int(cfg.model.get("density_token_c", 64)),
        density_token_kernel=int(cfg.model.get("density_token_kernel", 3)),
        density_token_hidden=int(cfg.model.get("density_token_hidden", 64)),
        density_token_offsets=bool(cfg.model.get("density_token_offsets", True)),
