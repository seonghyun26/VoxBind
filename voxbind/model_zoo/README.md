...
|---|---|---|---|---|
| `CDG_v2` 🏅 | copy of `atombias_100m_v2_e25` (`260806_cdg_100m_v2_ep100` **e25**) | v2 (112K) | 0.75 (**atom_biased**) | **0.653 / 0.666 / 1.355** — the paper's headline **CDG v2** row (gold) in `results.html` Tables 1a/1b/1c. MSE-only probe head; early-peak, reprobe `--epoch 25`. See `CDG_v2/MODELCARD.md`. |
| `interface_curriculum_100m_v2_e20` ⭐ | 260823_cdg_100m_v2_interface_curriculum_0609 (**e20**) | v2 (112K) | interface + curriculum 0.60→0.90 (e20 = 0.70 stage) | **Strongest all-around; beats champion on ALL 5 axes.** FULL 0.649 · CL123-leakproof 0.611 · lba30 **0.598** · lba60 **0.630** · **CASF clean-92 0.706±0.020 (5-seed) > ProFSA 0.676** (+0.030). Best NOVEL-protein generalization → recommended VoxBind transfer pick. Caveat: value at e20 (0.70 stage), later 0.80/0.90 stages hurt; CL123 < plain interface. Reprobe `--epoch 20` |
| `interface_100m_v2_e40` | 260821_cdg_100m_v2_interface_mask075 (**e40**) | v2 (112K) | 0.75 (**interface**) | FULL **0.648** · CL123-leakproof **0.626** (best CL123, > curriculum) · CASF clean-92 0.667±0.014 (5-seed) ≈ ProFSA 0.676. First PRETEXT-alignment win: masks the pocket-ligand CONTACT region. Stable e40 (declines by e49). Keep if CL123 is the priority. Reprobe `--epoch 40` |
| `atombias_100m_v2_e25` (= `CDG_v2` source) | 260806_cdg_100m_v2_ep100 (**e25**) | v2 (112K) | 0.75 (**atom_biased**) | **0.653 / 0.666 / 1.355** — best-on-record; CL3-leakproof ρ **0.622** (> champion 0.60). Early-peak: this 100-ep run peaks at e25 then declines (atom_biased overtrains); weight-soup of later epochs does NOT beat it |
