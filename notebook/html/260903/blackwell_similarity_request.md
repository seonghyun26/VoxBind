...
```bash
scp <thisbox>:/home1/irteam/VoxBind/notebook/html/build_reference_similarity.py ~/
```
...
- `notebook/html/build_reference_similarity.py` — 스크립트 본체, 모듈 docstring에 같은 내용
- `notebook/html/260903/ligand_similarity_appendix.txt` §5 — 재현 절차와 측정값
- `notebook/html/reference_similarity_metrics.md` — 지표별 출처 논문
