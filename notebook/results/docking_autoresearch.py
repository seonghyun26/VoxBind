...
Run (works with or without `conda activate voxbind` — PATH is self-healed):
    python notebook/results/docking_autoresearch.py                 # full autoresearch
    python notebook/results/docking_autoresearch.py --smoke         # ~3-min sanity run
    python notebook/results/docking_autoresearch.py --render-only notebook/html/<name>.json
"""
...
<div class="footer">
Generated by <code>notebook/results/docking_autoresearch.py</code> — autoresearch-style
docking-speed optimisation (inspired by
<a href="https://github.com/karpathy/autoresearch">karpathy/autoresearch</a>).
Re-run: <code>python notebook/results/docking_autoresearch.py</code> ·
